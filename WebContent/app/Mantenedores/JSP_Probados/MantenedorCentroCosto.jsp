							...
							<div class="col-sm-3 col-md-3">
								<div class="form-group">
									<input type="text" class="form-control" id="nombreInsert"
										name="nombre" value="" maxlength="40" onkeypress="return soloLetrasNumeros(event)"/> 
								</div>
							</div>
							<div class="col-sm-3 col-md-3">
								<div class="form-group">
							...
							<div class="col-sm-3 col-md-3">
								<div class="form-group">
									<input type="text" class="form-control" id="valorInsert"
										name="valor" value="" maxlength="30" onkeypress="return soloNumeros(event)"/> 
								</div>
							</div>
							<div class="col-sm-3 col-md-3">
								<div class="form-group">
										...
										<div class="col-sm-8 col-md-8">
											<div class="input-group input-append date">
												...
												<input type="text" name="sucursalDireccion" maxlength="30"
													value="" id="valorUpdate" size="30" class="form-control" onkeypress="return soloNumeros(event)"/>
