...
$(document).ready(function() {
	var filaTabla;
	  ...
	  var miTabla = $('#agendados').DataTable({
		    "columnDefs": [
					        	  ...
					        	  if(result.busquedaAgendamientosBean.length != 0){
						        	  for (var i=0;i<result.busquedaAgendamientosBean.length;i++){
							        	  miTabla.row.add([
							        			  ...
							        			  '<center><a href="Asignaciones?idAgendado='+result.busquedaAgendamientosBean[i].id+'" class="distribuir"> <span class="glyphicon glyphicon-pencil" style="color:green;"></span></a>'
							        			  +'<a href="Instalaciones?idAgendado='+result.busquedaAgendamientosBean[i].id+'" class="distribuir"> <span class="glyphicon glyphicon-wrench" style="color:green;"></span></a></center>'
									      ]).draw(false);
						        	     }
							        }else{
										miTabla.clear().draw();
...
<div class="container">
		...
		<s:form action="SucursalInsertar" name="SucursalInsertar" method="POST" autocomplete="off" id="SucursalInsertar"
				...
				<div class="panel panel-success">
					<div class="panel-heading" style="background-color: #fc8d00;" 
					align="center">Agendados</div>
							...
							<div class="col-sm-3 col-md-3">
								<div class="form-group">
									<input type="text" class="form-control" id="desde"
										name="desde" value="" maxlength="10" readonly="readonly"/> 
								</div>
							</div>
							<div class="col-sm-3 col-md-3">
								<div class="form-group">
							...
							<div class="col-sm-3 col-md-3">
								<div class="form-group">
									<input type="text" class="form-control" id="hasta"
										name="hasta" value="" maxlength="10" readonly="readonly"/> 
								</div>
							</div>
							<table class="table table-hover table-bordered table-condensed" id="agendados">
				<thead><tr><th>ID</th><th>Nombre/Apellido</th><th>Región</th><th>Comuna</th><th>Empresa</th><th>UEN</th><th>Centro de Costos</th><th>Dirección</th><th>Fecha</th><th>Estado</th><th>Asignar/Instalar</th></tr></thead>
				<tbody>
				</tbody>
