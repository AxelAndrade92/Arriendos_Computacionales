...
/* Date picker manager.
   ...
   allowing multiple different settings on the same page. */
	...
	this.regional[""] = { // Default regional settings
		...
		dayNames: ["Domingo", "Lunes", "Martes", "M&iacute;ercoles", "Jueves", "Viernes", "S&aacute;bado"], // For formatting
		dayNamesShort: ["Dom", "Lun", "Mar", "M&iacute;e", "Jue", "Vie", "S&aacute;b"], // For formatting
	...
	this._defaults = { // Global defaults for all the date picker instances
		...
		buttonImage: "recursos/image/calendar.gif", // URL for trigger button image
